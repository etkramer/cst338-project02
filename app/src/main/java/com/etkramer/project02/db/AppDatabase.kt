    ...
    companion object {
        ...
        private fun seedProducts(db: AppDatabase) {
            ...
            val products = arrayOf(
                ...
                Product(0, "Window Spray", "Introducing our Window Cleaner Spray, the secret to sparkling, streak-free glass and crystal-clear views. This powerful and efficient formula effortlessly cuts through dirt, smudges, and grime, leaving your windows glistening and spotless. With a quick...", 10),
